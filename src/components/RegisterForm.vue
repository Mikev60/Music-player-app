...
export default {
    ...
    data() {
        return {
            schema: { //each key is field name defined in name att
                name: "required|min:3|max:100|alpha_spaces",
                email: "required|email|min:3|max:100",
                age: "required|min_value:17|max_value:100",
            ...
            userData: { // Default values for form
                country: "USA"
            },
    ...
    methods: {
        ...
        async register(values) {
            ...
            try {
                ...
                this.reg_alert_message = "An error occured";
                console.log(error)
                return
            }
